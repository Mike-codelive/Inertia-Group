  ...
  return (
    <section className="container mx-auto my-6 grid gap-6 px-6 md:grid-cols-2">
      {sections.map((section) => (
        <Link key={section.title} to={section.href} className="group h-45.75 md:h-100 xl:h-125">
            ...
            <CardHeader className="relative z-10 text-white">
              <CardTitle className="text-[2rem] flex justify-between items-center">
                ...
                <Button
                  ...
                  type="button"
                  className="relative h-10 md:size-10.75 rounded-none px-6 cursor-pointer hover:bg-red-600"
                >
