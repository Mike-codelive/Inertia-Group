...
export function CatalogCard({ item }: Props) {
  return (
    <div className="group grid grid-cols-[150px_1fr] border border-black/20 dark:border-white/20 bg-white dark:bg-transparent hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
